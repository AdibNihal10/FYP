  ...
  useEffect(() => {
    const fetchGrantsData = async () => {
      try {
        ...
        // Prepare the data for the pie chart
        const chartData = [
          { id: "National Grants", value: jsonData.nationalGrants },
          { id: "Industry Grants", value: jsonData.industryGrants },
          { id: "International Grants", value: jsonData.internationalGrants },
        ];
